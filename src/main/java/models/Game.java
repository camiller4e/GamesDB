...
public class Game {
    ...
    @OneToMany(mappedBy = "fav_game", fetch = FetchType.LAZY)
    public List<Owner> getFans() {
        return fans;
    }

    public void setFans(List<Owner> fans) {
        this.fans = fans;
    }
}
